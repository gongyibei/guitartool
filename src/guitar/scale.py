...
DIATONIC_SCALE = ('C', 'bD', 'D', 'bE', 'E', 'F', 'bG', 'G', 'bA', 'A', 'bB', 'B')
...
class CommonScale():
    Ionian = Scale.frompitchs(('1', '2', '3', '4', '5', '6', '7'),
                              en_name='Ionian',
                              zh_name='自然大调音阶')
    Chromatic_Scale = Scale.frompitchs(('1', 'b2', '2', 'b3', '3', '4', 'b5', '5', 'b6', '6', 'b7', '7'),
                                       en_name='Chromatic Scale',
                                       zh_name='半音音阶')
...
def get_all_scale():
    all_scale = {}
    for name in dir(CommonScale):
        if name.startswith('_'):
            break
        scale = getattr(CommonScale, name)
        all_scale[scale.zh_name] = scale
    return all_scale


all_scale = get_all_scale()

if __name__ == '__main__':
    print(getattr(CommonScale, 'Todi_Theta').notes('A'))
